...
TEST_F(CommandTreeTest, GetCompleteOptions)
{
    ...
    std::map<std::string, std::vector<std::string>> test_data = { { "h", { "help" } },
        { "e", { "exit" } },
        { "t", { "tilt", "tower" } },
        { "print s", { "start", "stop" } },
...
TEST_F(CommandTreeTest, CompletePath)
{
    ...
    std::map<std::string, std::string> test_data = {
        ...
        { "print start filesystem_mock/Pictures/IMG20230303013",
            "print start filesystem_mock/Pictures/IMG2023030301314" },
        { "print start filesystem_mock/Pictures/IMG20230303013145",
            "print start filesystem_mock/Pictures/IMG20230303013145" },
