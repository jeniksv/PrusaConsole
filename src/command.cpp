...
command::command(const std::string& _name, bool _leaf) : _name(_name), _leaf(_leaf) {}
...
concrete_command_base::concrete_command_base(const std::string& name) : command(name, true), _args_vector() {}
